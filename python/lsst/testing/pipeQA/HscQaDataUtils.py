...
def getSourceSetNameList():
    ...
    accessors = [
        ...
        ["Ra",                           "ra2000",                        "D" ],
        ["Dec",                          "dec2000",                       "D" ],
        #["RaErrForWcs",                  "raSigmaForWcs",                "D" ],
        #["DecErrForWcs",                 "declSigmaForWcs",              "D" ],
        #["RaErrForDetection",            "raSigmaForDetection",          "D" ],
        #["DecErrForDetection",           "declSigmaForDetection",        "D" ],
        #["XFlux",                        "xFlux",                        "D" ],
        #["XFluxErr",                     "xFluxSigma",                   "D" ],
        #["YFlux",                        "yFlux",                        "D" ],
        #["YFluxErr",                     "yFluxSigma",                   "D" ],
        #["RaFlux",                       "raFlux",                       "D" ],
        #["RaFluxErr",                    "raFluxSigma",                  "D" ],
        #["DecFlux",                      "declFlux",                     "D" ],
        #["DecFluxErr",                   "declFluxSigma",                "D" ],
        #["XPeak",                        "xPeak",                        "D" ],
        #["YPeak",                        "yPeak",                        "D" ],
        #["RaPeak",                       "raPeak",                       "D" ],
        #["DecPeak",                      "declPeak",                     "D" ],
        ["XAstrom",                      "centroid_sdss_x",                      "D" ],
        #["XAstromErr",                   "xAstromSigma",                 "D" ],
        ["YAstrom",                      "centroid_sdss_y",                      "D" ],
        #["YAstromErr",                   "yAstromSigma",                 "D" ],
        #["RaAstrom",                     "raAstrom",                     "D" ],
        #["RaAstromErr",                  "raAstromSigma",                "D" ],
        #["DecAstrom",                    "declAstrom",                   "D" ],
        #["DecAstromErr",                 "declAstromSigma",              "D" ],
        #["TaiMidPoint",                  "taiMidPoint",                  "D" ],
        #["TaiRange",                     "taiRange",                     "D" ],
        ["PsfFlux",                      "flux_psf",                      "D" ],
        ["PsfFluxErr",                   "flux_psf_e",                 "D" ],
        ["ApFlux",                       "flux_sinc",                       "D" ],
        ["ApFluxErr",                    "flux_sinc_e",                  "D" ],
        ["ModelFlux",                    "flux_gaussian",                    "D" ],
        ["ModelFluxErr",                 "flux_gaussian_e",                    "D" ],
        #["ModelFlux",                    "flux_ESG",                 "D" ], 
        #["ModelFluxErr",                 "flux_ESG_Sigma",               "D" ],
        ["InstFlux",                     "flux_gaussian",                     "D" ],
        ["InstFluxErr",                     "flux_gaussian_e",                     "D" ],
        #["InstFlux",                      "flux_Gaussian",                     "D" ], 
        #["InstFluxErr",                  "flux_Gaussian_Sigma",                "D" ],
        #["NonGrayCorrFlux",              "nonGrayCorrFlux",              "D" ],
        #["NonGrayCorrFluxErr",           "nonGrayCorrFluxSigma",         "D" ],
        #["AtmCorrFlux",                  "atmCorrFlux",                  "D" ],
        #["AtmCorrFluxErr",               "atmCorrFluxSigma",             "D" ],
        #["ApDia",                        "apDia",                        "D" ],
        ["Ixx",                          "shape_sdss_xx",                          "D" ],
        #["IxxErr",                       "ixxSigma",                     "D" ],
        ["Iyy",                          "shape_sdss_yy",                          "D" ],
        ...
        #["IxyErr",                       "ixySigma",                     "D" ],
        #["PsfIxx",                       "psfIxx",                       "D" ],
        #["PsfIxxErr",                    "psfIxxSigma",                  "D" ],
        #["PsfIyy",                       "psfIyy",                       "D" ],
        #["PsfIyyErr",                    "psfIyySigma",                  "D" ],
        #["PsfIxy",                       "psfIxy",                       "D" ],
        #["PsfIxyErr",                    "psfIxySigma",                  "D" ],
        #["Resolution",                   "resolution_SG",                "D" ],
        #["E1",                           "e1_SG",                        "D" ],
        #["E1Err",                        "e1_SG_Sigma",                  "D" ],
        #["E2",                           "e2_SG",                        "D" ],
        #["E2Err",                        "e2_SG_Sigma",                  "D" ],
        #["Shear1",                       "shear1_SG",                    "D" ],
        #["Shear1Err",                    "shear1_SG_Sigma",              "D" ],
        #["Shear2",                       "shear2_SG",                    "D" ],
        #["Shear2Err",                    "shear2_SG_Sigma",              "D" ],
        #["Sigma",                        "sourceWidth_SG",               "D" ],
        #["SigmaErr",                     "sourceWidth_SG_Sigma",         "D" ],
        #["ShapeStatus",                  "shapeStatus",                  "D" ],
        #["Snr",                          "snr",                          "D" ],
        #["Chi2",                         "chi2",                         "D" ],
        #["FlagForAssociation",           "flagForAssociation",           "D" ],
        #["FlagForDetection",             "flagForDetection",             "D" ],
        #["FlagForWcs",                   "flagForWcs",                   "D" ],

        # source
        ["FlagBadCentroid",               "flag005", "I" ],
        ["FlagPixSaturCen",               "flag011", "I" ],
        ["FlagPixInterpCen",              "flag009", "I" ],
        ["FlagPixEdge",                   "flag007", "I" ],
        ["FlagNegative",                  "flag004", "I" ],
        ...
        ["Extendedness",                  "classification_extendedness",                 "D" ],
        ]
    return accessors
...
def getSourceSetAccessorsAndTypes():
    nameList = getSourceSetNameList()
    z = zip(*nameList)
    return z[0], z[2]
